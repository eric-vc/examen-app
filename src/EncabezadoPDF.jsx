...
export default function EncabezadoPDF({ asignatura, unidad, tema, opcion, alumnoNombre, numControl, unidadAcademica, calificacion, fecha, docenteNombre }) { // <--- AGREGADO docenteNombre
  
  // ELIMINAMOS LA CONSTANTE FIJA: const DOCENTE = "..." 
    ...
    <div style={{ width: '100%', fontFamily: 'Arial, sans-serif', fontSize: '10pt', marginBottom: '20px' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', marginBottom: '10px', paddingBottom: '5px' }}>
        <img 
          ...
          alt="Logo ITSZ" 
          style={{ height: '60px', marginRight: '15px', objectFit: 'contain' }} 
        />
      ...
      <table style={{ width: '100%', borderCollapse: 'collapse', border: '1px solid black' }}>
        <tbody>
          ...
          <tr>
            ...
            <td colSpan="2" style={{ border: '1px solid black', padding: '4px' }}>
              {/* AQUÍ USAMOS EL PROPS DINÁMICO */}
              <strong>Docente:</strong> {docenteNombre || "_______________________"}
            </td>
          </tr>
